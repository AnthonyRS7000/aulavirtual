...
import "../css/BibliotecaDocente.css";
...
const BibliotecaDocente = () => {
    ...
    return (
        <div className="biblioteca-docente-container">

          <div className="mensajeria-docente-header">
            <h1 className="mensajeria-docente-titulo">Biblioteca</h1>
            <p className="mensajeria-docente-subtitulo">
              Revisa una amplia variedad de repositorios con un solo Click !!
            </p>
          </div>

            {/* Card principal */}
            <div className="biblioteca-docente-card-items">
...
export default BibliotecaDocente;
